...
namespace TeamManager.Manual
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRaceEntryManager, RaceEntryManager>();
            services.AddScoped<IRaceResultManager, RaceResultManager>();
            services.AddScoped<IUserRaceRepository, UserRaceRepository>();
